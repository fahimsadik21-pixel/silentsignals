...
export async function POST(request: Request) {
  ...
  try {
      ...
      return jsonResponse(
        {
          error: {
            ...
            message: "Use a valid name and official email address.",
          },
        },
        422,
      );
      ...
      return jsonResponse(
        {
          error: {
            code,
            message: "This team invite is invalid, expired, or already used.",
          },
        },
        422,
      );
    if (code === "ACCOUNT_EXISTS")
      return jsonResponse(
        {
          error: { code, message: "An account already exists for this email." },
        },
        409,
      );
